...
基于 [Hermes Agent](https://github.com/NousResearch/hermes-agent) 的自托管 AI Agent 平台。多用户、团队协作、Web 工作区，通过 ACP（Agent Client Protocol）驱动后台 Agent 会话。

**[English](README_EN.md)** | 中文

## 这是什么

Hermes Agent 是一个 CLI 优先的 AI 编程 Agent。Hermes Python 在此基础上加了一层 **Web 应用**：
