...
from app.api.v1 import admin, agents, analytics, auth, branding, conversations, feedback, files_browser, gallery, health, logs, memory, notifications, presence, scheduled, skill_evolution, sop, teams, terminal, users
...
api_router.include_router(sop.router, prefix="/sop-skills", tags=["sop"])
