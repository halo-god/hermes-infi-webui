...
PERMISSIONS: list[dict] = [
    ...
    {"id": "task.move", "group": "项目", "label": "推进任务状态"},
    {"id": "task.derive", "group": "项目", "label": "从会话生成任务"},
    ...
    {"id": "conversation.consolidate", "group": "会话与助手", "label": "沉淀产出为文档 / 知识"},
    {"id": "channel.clear", "group": "会话与助手", "label": "清空群聊记录"},
    {"id": "channel.manage_agents", "group": "会话与助手", "label": "管理群聊助手"},
